		...
		<h3 class="legenda"> Lista de anúncios finalizados por vendas</h3>

		<div class="col-md-12">
			<form name="form-gerenciador" class="" id="form-gerenciador" method="get" autocomplete="off" action="<?php echo site_url('anuncios/finalizados_venda'); ?>">
				<p>Há um total de <?php echo $count_anuncios;?> anúncios finalizados por vendas</p>
				...
				<div class="form-group">
					...
					<div class="col-xl-4 pull-left" style="    margin-top: 30px;">
						<a href="<?php echo site_url('anuncios/finalizados_venda'); ?>" class="btn btn-default"> Limpar </a>
