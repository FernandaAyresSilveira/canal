<?php 
	...
	class Anuncios extends MY_Controller {
		...
		public function listar()
		{
			...
			$config['base_url'] 			= $this->input->get() ? site_url('anuncios/listar').'?q='.$this->input->get('q').'&d='.$this->input->get('d') : site_url('anuncios/listar?g=1');
		...
		public function duplicar()
		{
			...
			if(
				...
				if ($duplicar->imagem1) {
					copy("./assets/upload/anuncios/".$duplicar->id.'/'.$duplicar->imagem1,
					"./assets/upload/anuncios/".$id.'/'.$duplicar->imagem1);
				}
				if ($duplicar->imagem2) {
					copy("./assets/upload/anuncios/".$duplicar->id.'/'.$duplicar->imagem2,
					"./assets/upload/anuncios/".$id.'/'.$duplicar->imagem2);
				}
				if ($duplicar->imagem3) {
					copy("./assets/upload/anuncios/".$duplicar->id.'/'.$duplicar->imagem3,
					"./assets/upload/anuncios/".$id.'/'.$duplicar->imagem3);
				}
				if ($duplicar->imagem4) {
					copy("./assets/upload/anuncios/".$duplicar->id.'/'.$duplicar->imagem4,
					"./assets/upload/anuncios/".$id.'/'.$duplicar->imagem4);
				}
				if ($duplicar->imagem5) {
					copy("./assets/upload/anuncios/".$duplicar->id.'/'.$duplicar->imagem5,
					"./assets/upload/anuncios/".$id.'/'.$duplicar->imagem5);
				}
		...
		public function funcao_excluir()
		{
			...
			if( $this->anuncio->delete( $this->uri->segment(3) ) ){
				...
				if( !empty($imagem1) ){ unlink("./assets/upload/anuncios/".$this->uri->segment(3)."/$imagem1");}
				if( !empty($imagem2) ){ unlink("./assets/upload/anuncios/".$this->uri->segment(3)."/$imagem2");}
				if( !empty($imagem3) ){ unlink("./assets/upload/anuncios/".$this->uri->segment(3)."/$imagem3");}
				if( !empty($imagem4) ){ unlink("./assets/upload/anuncios/".$this->uri->segment(3)."/$imagem4");}
				if( !empty($imagem5) ){ unlink("./assets/upload/anuncios/".$this->uri->segment(3)."/$imagem5");} 
