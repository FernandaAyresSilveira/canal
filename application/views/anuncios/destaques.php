		...
		<h3 class="legenda"> Lista de destaques</h3>

		<div class="col-md-12">
			<p>Há um total de <?php echo $total;?> anúncios destacados</p>
				<form name="form-gerenciador" class="" id="form-gerenciador" method="get" autocomplete="off" action="<?php echo site_url('anuncios/destaques'); ?>">
			...
			<div class="form-group">
					...
					<div class="col-xl-4 pull-left" style="    margin-top: 30px;">
						<a href="<?php echo site_url('anuncios/destaques'); ?>" class="btn btn-default"> Limpar </a>
				        ...
				        <tr>
				            <td class="col-xs-2"> 
				            	...
				            	<a href="<?php echo site_url("anuncios/duplicar/$anuncio->id"); ?>" title="Duplicar" class="btn btn-warning btn-sm pull-left" >Dupli
				            	 ...
				            	 <a href="<?php echo base_url('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem1);?>" class="fancybox btn btn-sm btn-default  pull-left" title="Foto" style='margin-left:  9px'> 
