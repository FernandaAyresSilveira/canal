	...
	<form name="form-gerenciador" enctype="multipart/form-data" id="form-gerenciador" method="post" autocomplete="off" action="<?php echo site_url("anuncios/funcao_editar/$anuncio->id"); ?>">
		<h3 class="legenda"> Editar anúncio</h3>
		...
		<div class="col-xl-11">
				...
				<div class="col-xl-12">				
					...
					<textarea name="descricao" class="form-control" style="resize: none;height: 200px"><?php echo $anuncio->descricao; ?></textarea>
				</div>
				</div>
				<br class="clear">
				<div class="col-xl-12">				
				...
				<div class="col-xl-12 pull-left">
					...
					<?php if($anuncio->imagem1 && file_exists('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem1)){?>
					<div class="col-xl-3 pull-left" style="margin-top: 18px" id="imagem-1">
						<a href="<?php echo base_url('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem1);?>" class="fancybox btn btn-default pull-right"> 
				...
				<div class="col-xl-12 pull-left">
					...
					<?php if($anuncio->imagem2 && file_exists('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem2)){?>
					<div class="col-xl-3 pull-left" style="margin-top: 18px">
						<a href="<?php echo base_url('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem2);?>" class="fancybox btn btn-default pull-right" > 
								<i class="fa fa fa-picture-o" aria-hidden="true"></i>
						</a>
					</div>
				...
				<div class="col-xl-12 pull-left">
					...
					<?php if($anuncio->imagem3 && file_exists('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem3)){?>
					<div class="col-xl-3 pull-left" style="margin-top: 18px">
						<a href="<?php echo base_url('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem3);?>" class="fancybox btn btn-default pull-right"  > 
								<i class="fa fa fa-picture-o" aria-hidden="true"></i>
						</a>
					</div>
				...
				<div class="col-xl-12 pull-left">
					...
					<?php if($anuncio->imagem4 && file_exists('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem4)){?>
					<div class="col-xl-3 pull-left" style="margin-top: 18px">
						<a href="<?php echo base_url('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem4);?>" class="fancybox btn btn-default pull-right"  > 
								<i class="fa fa fa-picture-o" aria-hidden="true"></i>
						</a>
					</div>
				...
				<div class="col-xl-12 pull-left">
					...
					<?php if($anuncio->imagem5 && file_exists('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem5)){?>
					<div class="col-xl-3 pull-left" style="margin-top: 18px">
						<a href="<?php echo base_url('./assets/upload/anuncios/'.$anuncio->id.'/'.$anuncio->imagem5);?>" class="fancybox btn btn-default pull-right"  > 
								<i class="fa fa fa-picture-o" aria-hidden="true"></i>
						</a>
					</div>
