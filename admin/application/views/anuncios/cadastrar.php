	...
	<form name="form-gerenciador" enctype="multipart/form-data" id="form-gerenciador" method="post" action="<?php echo site_url('anuncios/funcao_cadastrar'); ?>">
		...
		<fieldset class="area-padrao verde tamanho-70 centro">
			...
			<h3 class="legenda"> Cadastro de anúncio - Raul </h3>
			<div class="col-xl-10">
				...
				<div class="col-xl-12 pull-left">			
					...
					<div class="col-xl-2 pull-left">
						<br class="clear">
						<input type="submit" value="Cadastrar" style="margin-top: 5px !important" class="btn btn-success pull-right" />
					</div>
				</div>
				<br class="clear">
				<br class="clear">
				...
				<div class="col-xl-12">	
					<div class="col-xl-12 pull-left">					
						...
						<textarea name="descricao" class="form-control" style="resize: none;height: 80px"></textarea>
					</div>
				</div>
				<br class="clear">
				<br class="clear">
				...
				<!-- 	<div class="col-xl-2 pull-left">
					...
					<div class="col-xl-3 pull-left">
						...
						<input type="checkbox" name="somente_pac" id="somente_pac" class="form-control pull-left" style="display: inline; width: auto; margin-top: 6px;margin-left: 5px" />
					</div>
				</div>
				<br class="clear">
				<br class="clear">
