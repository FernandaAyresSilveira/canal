		...
		<h3 class="legenda"> Lista de anúncios visualizados</h3>

		<div class="col-md-12">
			<form name="form-gerenciador" class="" id="form-gerenciador" method="get" autocomplete="off" action="<?php echo site_url('anuncios/visualizados'); ?>">
				<p>Há um total de <?php echo $count_anuncios;?> anúncios visualizados no site</p>
				...
				<div class="form-group">
					...
					<div class="col-xl-4 pull-left" style="    margin-top: 30px;">
						<a href="<?php echo site_url('anuncios/visualizados'); ?>" class="btn btn-default"> Limpar </a>
			...
			<table class="table table-bordered">			    	
		    	...
		    	<?php foreach( $anuncios AS $anuncio ){   	?>
				        <tr>
				            ...
				            <td><?php echo $anuncio->visualizado; ?></td>	
				        </tr>
		        <?php } ?>
			</table>
		<br class="clear" />
