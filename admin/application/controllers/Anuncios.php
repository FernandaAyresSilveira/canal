<?php 
	...
	class Anuncios extends MY_Controller {
			...
			if( !empty($_FILES['imagem1']['name']) ){
					...
					if(in_array($ext, $per)) {
						...
						if (upload('anuncios/'.$id, 'imagem1', $imagem1)){
							$this->anuncio->setImagem($id,'imagem1', $imagem1);
							criar_thumb($id,$imagem1);
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga1) && $antiga1 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga1);
							}
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga1) && $antiga1 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga1);
							}
						}else{
							$erro++;
						}
				...
				if( !empty($_FILES['imagem2']['name']) ){
					...
					if(in_array($ext, $per)) {
						...
						if (!upload('anuncios/'.$id, 'imagem2', $imagem2, '5000')){
							...
							$this->anuncio->setImagem($id,'imagem2', $imagem2);
							criar_thumb($id,$imagem2);
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga2) && $antiga2 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga2);
							}
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga2) && $antiga2 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga2);
							}
						}
					}
					else
				...
				if( !empty($_FILES['imagem3']['name']) ){
					...
					if(in_array($ext, $per)) {
						...
						if (!upload('anuncios/'.$id, 'imagem3', $imagem3, '5000')){
							...
							$this->anuncio->setImagem($id,'imagem3', $imagem3);
							criar_thumb($id,$imagem3);
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga3) && $antiga3 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga3);
							}
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga3) && $antiga3 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga3);
							}
						}
					}
					else
				...
				if( !empty($_FILES['imagem4']['name']) ){
					...
					if(in_array($ext, $per)) {
						...
						if (!upload('anuncios/'.$id, 'imagem4', $imagem4, '5000')){
							...
							$this->anuncio->setImagem($id,'imagem4', $imagem4);
							criar_thumb($id,$imagem4);
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga4) && $antiga4 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga4);
							}
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga4) && $antiga4 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga4);
							}
						}
					}
					else
				...
				if( !empty($_FILES['imagem5']['name']) ){
					...
					if(in_array($ext, $per)) {
						...
						if (!upload('anuncios/'.$id, 'imagem5', $imagem5, '5000')){
							...
							$this->anuncio->setImagem($id,'imagem5', $imagem5);
							criar_thumb($id,$imagem5);
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga5) && $antiga5 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$antiga5);
							}
							if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga5) && $antiga5 !='') {
								unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$antiga5);
							}
						}
					}
					else
		...
		public function duplicar()
		{
			...
			if(
				...
				if ($duplicar->imagem1 != '' && file_exists("./../admin/assets/upload/anuncios/".$id_duplicar."/".$duplicar->imagem1)) {
					...
					criar_thumb($id,$duplicar->imagem1);
				}
				if ($duplicar->imagem2 != '' && file_exists("./../admin/assets/upload/anuncios/".$id_duplicar."/".$duplicar->imagem2)) {
					...
					criar_thumb($id,$duplicar->imagem2);
				}
				if ($duplicar->imagem3 != '' && file_exists("./../admin/assets/upload/anuncios/".$id_duplicar."/".$duplicar->imagem3)) {
					...
					criar_thumb($id,$duplicar->imagem3);
				}
				if ($duplicar->imagem4 != ''  && file_exists("./../admin/assets/upload/anuncios/".$id_duplicar."/".$duplicar->imagem4)) {
					...
					criar_thumb($id,$duplicar->imagem4);
				}
				if ($duplicar->imagem5 != '' && file_exists("./../admin/assets/upload/anuncios/".$id_duplicar."/".$duplicar->imagem5)) {
					...
					criar_thumb($id,$duplicar->imagem5);
				}
		...
		public function funcao_excluir()
		{
			...
			if( $this->anuncio->delete( $this->uri->segment(3) ) ){
				...
				&& file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/$imagem1") ){ 
					...
					if (file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem1")) {
						unlink("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem1");
					}
				}
				if( !empty($imagem2) &&
				file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/$imagem2") ){ 
					...
					if (file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem2")) {
						unlink("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem2");
					}
				}
				if( !empty($imagem3) && 
				file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/$imagem3" ) ){ 
					...
					if (file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem3")) {
						unlink("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem3");
					}
				}
				if( !empty($imagem4) &&
				file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/$imagem4" ) ){ 
					...
					if (file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem4")) {
						unlink("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem4");
					}
				}
				if( !empty($imagem5) && 
				file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/$imagem5") ){ 
					...
					if (file_exists("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem5")) {
						unlink("./../admin/assets/upload/anuncios/".$this->uri->segment(3)."/mini_$imagem5");
					}
				} 
		...
		public function excluirImg(){
			...
			if ($coluna==1) { 
				unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$anuncio->imagem1);
				if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem1)) {
					unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem1);
				}
			}			
			if ($coluna==2) { 
				unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$anuncio->imagem2);
				if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem2)) {
					unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem2);
				}
			}			
			if ($coluna==3) { 
				unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$anuncio->imagem3);
				if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem3)) {
					unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem3);
				}
			}			
			if ($coluna==4) { 
				unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$anuncio->imagem4);
				if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem4)) {
					unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem4);
				}
			}			
			if ($coluna==5) { 
				unlink('./../admin/assets/upload/anuncios/'.$id.'/'.$anuncio->imagem5);
				if (file_exists('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem5)) {
					unlink('./../admin/assets/upload/anuncios/'.$id.'/mini_'.$anuncio->imagem5);
				}
			}		
